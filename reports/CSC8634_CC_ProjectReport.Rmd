...
1. **jobId** ID of the Azure batch job.
2. **taskId** ID of the Azure batch task.
3. **x** X co-ordinate of the image tile being rendered.
4. **y** Y co-ordinate of the image tile being rendered.
...
The csv files were read into R
