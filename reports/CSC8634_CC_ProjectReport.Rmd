...
knitr::opts_knit$set(root.dir= normalizePath('~/Desktop/DS_Projects/CSC8634_CC_Project'))
...
#### 2.1.3 Task X Y (task-x-y.csv 6.2MB)
...
```{r eda_01, fig.cap = "Typical GPU Performance Metrics over Time", fig.pos = "H", out.width='80%', fig.asp=0.75, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, results= 'hide'}
...
```{r eda_02, fig.cap = "GPU Performance Metrics Correlation", fig.pos = "H", out.width='80%', fig.asp=0.75, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, results= 'hide'}
