...
## 4.6 Affect on Execution Time of GPU Enviornmental and Resource Factors

The variation in rendering by pixel can be elaborated by examining the relationship between the GPU log metrics and execution time. 


```{r eda_f09, fig.cap = "Execution Time by GPU Enviromental and Resource Metrics", fig.pos = "H", out.width='80%', fig.asp=0.75, fig.align='center', cache=FALSE}
...
```{r eda_f10, fig.cap = "Execution Time by GPU S/N", fig.pos = "H", out.width='80%', fig.asp=0.75, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, results= 'hide', cache=TRUE}
