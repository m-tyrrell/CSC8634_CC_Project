...
```{r eda_03, echo=FALSE, cache=TRUE}
...
```{r eda_03x, echo=FALSE, cache=TRUE}
...
knitr::kable(task_runtime_means, booktabs = TRUE, caption = 'Mean Runtime Durations by Event (Level 12 only)')
```
...
```{r eda_09, fig.cap = "Distribution by GPU \\& Memory: Render", fig.pos = "H", out.width='100%', fig.asp=0.75, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, results= 'hide', cache=FALSE}
grid.arrange(p22, p23, ncol=1)
grid.arrange(p20,p21,p22, p23, ncol=2)
```


```{r eda_10, fig.cap = "Distribution by GPU \\& Memory: Render", fig.pos = "H", out.width='100%', fig.asp=0.75, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, results= 'hide', cache=TRUE}
...
```{r eda_11, fig.cap = "Distribution by CPU \\& Memory: Render", fig.pos = "H", out.width='80%', fig.asp=0.75, fig.align='center', echo=FALSE, message=FALSE, warning=FALSE, results= 'hide'}
